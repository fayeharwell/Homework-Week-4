...
### Question 4: Plot the relevant Poisson mass function over the values in range 0 ≤ xx ≤ 30
...
```{r}
probset <- rpois(104, lambda = 8)
hist(probset, xlab = "Number of Calls", ylab = "Frequency of Call Amounts", xlim= c(0,30), main = "Histogram of Daily Call Counts")
